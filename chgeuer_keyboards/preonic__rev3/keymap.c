...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK_DH] = LAYOUT_preonic_1x2uC(
        ...
        KC_LCTL  , KC_LGUI  , KC_LALT  , KC_BSPC  , LOWER    , _______KC_SPC______ , RAISE    , KC_ENT   , KC_DEL   , KC_RGUI  , KC_RCTL ),
    ...
    [_RAISE] = LAYOUT_preonic_1x2uC(
        ...
        KC_LCTL  , KC_LGUI  , KC_LALT  , KC_BSPC  , ADJUST   , _______KC_SPC______ , KC_TRNS  , KC_BTN1  , KC_BTN2  , ________ , KC_END   ),
    ...
    [_ADJUST] = LAYOUT_preonic_1x2uC(
        ...
        KC_LCTL  , KC_LGUI  , KC_LALT  , KC_BSPC  , KC_TRNS  ,       SNAGIT        , KC_TRNS  , ________ , ________ , ________ , RESET    )
};
